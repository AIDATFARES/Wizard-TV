...
type Category = "About Wizard TV" | "Setup & streaming" | "Plans & access" | "Payments & support";
...
const categories: { label: Category; icon: typeof CircleHelp }[] = [
  { label: "About Wizard TV", icon: CircleHelp },
...
const faqs: FAQItem[] = [
  {
    category: "About Wizard TV",
    question: "1. What is Wizard TV?",
    answer: (
      <>
        Wizard TV is a premium IPTV service that offers live TV, VOD movies, TV series, and sports channels in high-quality streaming, including 4K. Check out our{" "}
  ...
  {
    category: "About Wizard TV",
    question: "2. Is Wizard TV authorized?",
    answer: (
      <>
        Wizard TV is intended to be used in accordance with applicable laws, local regulations, and our service terms. Please ensure that the content you access and the way you use the service are permitted in your location.
      </>
    ),
  },
  {
    category: "About Wizard TV",
    question: "3. What channels and content are included with Wizard TV?",
    answer: (
      <>
        Wizard TV includes a broad selection of live channels covering sports, news, and entertainment, along with a regularly updated on-demand library of movies and TV series. Check our <Link href="/channels" className="text-primary-500 font-semibold hover:text-primary-400 transition-colors">full channels catalog</Link>.
      </>
    ),
  },
  {
    category: "About Wizard TV",
    question: "4. Can I watch live sports and PPV events on Wizard TV?",
    answer: (
      <>
        Wizard TV includes a range of live sports channels and events. Coverage can include football, NFL, NBA, UFC, and pay-per-view events. Explore our <Link href="/channels" className="text-primary-500 font-semibold hover:text-primary-400 transition-colors">live sports section</Link>.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Wizard TV works with compatible IPTV apps on Smart TVs, Android TV, Firestick, Apple TV, smartphones, tablets, and computers. Follow our <Link href="/installation" className="text-primary-500 font-semibold hover:text-primary-400 transition-colors">installation guides</Link> to get started.
      </>
    ),
  },
  {
    category: "Setup & streaming",
    question: "1. How do I install Wizard TV on my device?",
    answer: (
      <>
        Start by installing a compatible IPTV player on your device. Enter the Wizard TV credentials from your email. View our step-by-step <Link href="/installation" className="text-primary-500 font-semibold hover:text-primary-400 transition-colors">installation guides</Link> for detailed instructions.
      </>
    ),
  },
  {
    category: "Setup & streaming",
    question: "2. Can I use Wizard TV on a Smart TV?",
    answer: (
      <>
        Yes, Wizard TV can be used on Smart TVs including Samsung, LG, and Android TV models using compatible IPTV players like Tivimate or Smarters.
      </>
    ),
  },
  {
    category: "Setup & streaming",
    question: "3. What internet speed do I need for smooth Wizard TV streaming?",
    answer: (
      <>
  ...
  {
    category: "Setup & streaming",
    question: "4. Why is Wizard TV buffering or freezing?",
    answer: (
      <>
  ...
  {
    category: "Setup & streaming",
    question: "5. Do I need a VPN to use Wizard TV?",
    answer: (
      <>
  ...
  },
  {
    ...
    question: "1. Are there any hidden fees or contracts with Wizard TV?",
    answer: (
      <>
  ...
  {
    category: "Plans & access",
    question: "2. Can I use Wizard TV on multiple devices?",
    answer: (
      <>
  ...
  {
    category: "Plans & access",
    question: "3. What are Wizard TV M3U and Xtream Codes details?",
    answer: (
      <>
  ...
  },
  {
    ...
    question: "1. Does Wizard TV offer a free trial?",
    answer: (
      <>
        Yes, we offer a <a href="https://wa.me/213552069874?text=Hello,%20I%20would%20like%20to%20request%20a%20free%20trial%20for%20Wizard%20TV." target="_blank" rel="noreferrer" className="text-primary-500 font-semibold hover:text-primary-400 transition-colors">free trial</a> so you can test our service before subscribing.
      </>
    ),
  },
  {
    category: "Payments & support",
    question: "2. Which payment methods does Wizard TV accept?",
    answer: (
      <>
        We accept PayPal, Crypto (Bitcoin & USDT), Credit Cards, and Instant Bank Transfers. For help with payments, reach out to our <Link href="/contact" className="text-primary-500 font-semibold hover:text-primary-400 transition-colors">support team</Link>.
      </>
    ),
  },
  {
...
export default function FAQ() {
  const [activeCategory, setActiveCategory] = useState<Category>("About Wizard TV");
  ...
  function sendSupportMessage(formData: FormData) {
    ...
    const text = encodeURIComponent(`Hello Wizard TV support,\n\nName: ${name}\nEmail: ${email}\nSubject: ${subject}\n\n${message}`);
    window.open(`https://wa.me/213552069874?text=${text}`, "_blank", "noopener,noreferrer");
  }

  return (
    <main className="flex-grow px-4 sm:px-6 pb-20 pt-4 md:pt-6 bg-white">
                    ...
                    <button
                      ...
                      className={`flex shrink-0 items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-semibold transition-all md:w-full ${
                        isSelected
                          ...
                          : "text-slate-600 hover:bg-black/[0.04] hover:text-black"
                      }`}
                      key={label}
        ...
        <section className="mt-20 border-t border-black/10 pt-16 sm:pt-20">
          ...
          <div className="mt-10 grid gap-8 xl:grid-cols-[278px_minmax(0,1fr)] xl:gap-10">
            <div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
              <a className="flex min-h-40 flex-col items-center justify-center rounded-2xl border border-black/10 bg-white p-5 text-center transition-colors hover:border-primary-500/50" href="mailto:support@wizardtv.site">
