...
const faqs = [
  {
    ...
    answer: (
      <>
        ...
        <Link
          href="/channels"
          className="text-[#8A2BE2] font-semibold hover:text-amber-500 transition-colors"
        >
          live TV channels
        </Link>{" "}
        and{" "}
  ...
  {
    id: 2,
    question: "2. Do I need a subscription to use Wizard TV?",
    answer: (
      <>
  ...
  {
    id: 3,
    question: "3. What devices are compatible with Wizard TV?",
    answer: (
      <>
        Wizard TV works on Android TV, Firestick, Smart TVs, Android phones, tablets, and apps like Tivimate. Follow our step-by-step{" "}
        <Link
          href="/installation"
          className="text-[#8A2BE2] font-semibold hover:text-amber-500 transition-colors"
        >
  ...
  {
    id: 5,
    question: "5. Can I watch sports on Wizard TV?",
    answer: (
      <>
  ...
  },
  {
    ...
    answer: (
      <>
        We accept PayPal, cryptocurrency (such as Bitcoin & USDT), credit cards, and instant bank transfers for quick and secure payments. Contact our{" "}
        <Link
          href="/contact"
          className="text-[#8A2BE2] font-semibold hover:text-amber-500 transition-colors"
        >
    ...
    <section className="py-20 bg-white text-black relative z-10 border-t border-black/10 overflow-hidden">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <span className="inline-block py-1.5 px-4 rounded-full bg-[#8A2BE2]/10 text-[#8A2BE2] font-bold text-xs tracking-widest uppercase mb-6 border border-[#8A2BE2]/20 animate-fade-up">
            SUPPORT & HELP
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6 max-w-[1140px] mx-auto">
          {faqs.map((faq, index) => (
            <div
              key={faq.id}
              className="flex flex-col rounded-2xl overflow-hidden border border-black/10 bg-white shadow-xl hover:border-[#8A2BE2]/40 transition-colors animate-fade-up"
            ...
            >
              ...
              <div className="bg-slate-100 border-b border-black/10 px-5 py-4 flex items-center gap-3">
                <HelpCircle className="w-5 h-5 text-[#8A2BE2] shrink-0" />
        ...
        <div className="mt-12 text-center animate-fade-up" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
          <Link
            href="/faq"
            className="inline-flex items-center gap-2.5 px-7 py-3 rounded-full bg-[#8A2BE2] text-white font-bold text-xs sm:text-sm hover:bg-[#7C3AED] transition-all duration-300 shadow-lg"
          >
