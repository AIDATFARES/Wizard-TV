...
const benefits = [
  ...
  { icon: Globe2, title: "Works Worldwide", text: "Enjoy Wizard TV wherever you are, on any connection.", color: "text-primary-400" },
  ...
  return <section className="relative overflow-hidden bg-white py-24 sm:py-28">
    ...
    <div className="relative mx-auto max-w-[1120px] px-5 sm:px-8">
      <div className="mx-auto mb-14 max-w-3xl text-center">
        <span className="inline-flex rounded-full border border-primary-400/35 bg-primary-400/[0.06] px-4 py-1.5 text-[10px] font-extrabold uppercase tracking-[0.18em] text-primary-300">Why choose Wizard TV?</span>
        <h2 className="mt-6 text-4xl font-black uppercase leading-[0.98] tracking-tight text-black sm:text-5xl"><span className="block">The Ultimate</span><span className="mt-1 block bg-gradient-to-r from-primary-400 via-primary-400 to-primary-400 bg-clip-text text-transparent">Wizard TV Experience</span></h2>
